...
# Add important note
ax1.text(5.5, 1.2, 'Hidden layer learns visual features WITHOUT seeing digit labels!', 
...
# Create a simple text-based diagram as well
print("\n" + "="*70)
print("SSL TRANSFER LEARNING FLOW - TEXT DIAGRAM")
print("="*70)
print("""
STAGE 1: SELF-SUPERVISED LEARNING (Rotation Prediction)
--------------------------------------------------------
Original Data (1797, 64) --> Rotate 4x --> Rotation Dataset (7188, 64)
                                                    |
                                                    v
                                            TwoLayerNet Training
                                            Input (64) -> Hidden (32) -> Output (4)
                                            Learns to predict rotation angles
                                            
                    *** Hidden layer learns features WITHOUT digit labels! ***

STAGE 2: TRANSFER LEARNING (Digit Classification)  
--------------------------------------------------------
Same Original Data (1797, 64) --> Extract Hidden Features --> ssl_features (1797, 32)
         +                                                            |
    Digit Labels y                                                   |
                                                                     v
                                                    ...
                                                    -----------------+------------------
                                                    |                                  |
                                            Train (1258, 32)                   Test (539, 32)
                                                    |                                  |
                                                    v                                  v
                                            Logistic Regression            Evaluate Accuracy
                                            (32 features -> 10 classes)

KEY INSIGHT: ssl_features are the SAME 1797 samples, just in a new 32D representation!
""")
print("="*70)